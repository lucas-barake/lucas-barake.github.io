...
But now you need another schema for encoding back to API format:
...
The issue here is that Zod only handles one-way transformation. You need separate schemas for decoding and encoding, which you must maintain manually. This becomes cumbersome very quickly, and you can imagine how this would scale.
