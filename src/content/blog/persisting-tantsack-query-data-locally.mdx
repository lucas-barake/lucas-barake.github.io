...
However, since Effect Schema comes with a lot of built-in transformations, such as `pluck`, `rename`, etc, there's no need to manually define these transformations for this example - though it totally depends on what you need.
