---
title: Building a Composable Policy System in TypeScript with Effect
date: 2025-03-04
description: "In this guide, we'll build a composable, type-safe, and scalable access control system in TypeScript and Effect."
---

import Youtube from "../components/Youtube.astro";

<Youtube id="6IaEhu8epnA" />
