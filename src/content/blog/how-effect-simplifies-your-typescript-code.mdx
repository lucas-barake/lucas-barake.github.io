...
date: 2024-11-03
description: "An exploration of modern web development practices and how they're shaping the future of the internet. We'll dive into recent trends and emerging technologies."
---
...
6. Queue all concurrent requests while a session refresh is in progress (since we know they'll fail with 401, let's avoid making them altogether).

Bonus challenges: 7. Design the solution to be composable with support for dependency injection. 8. Implement telemetry by:
