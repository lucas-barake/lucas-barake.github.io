...
This kind of complex authorization rule would be cumbersome to implement with traditional if-statements, but with our policy system, it's just a simple type-safe composition.
